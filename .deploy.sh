...
curl -T helloworld-0.0.$TRAVIS_BUILD_NUMBER-amd64.deb -uvladimirsuvorov:$BINTRAY_API_KEY "https://api.bintray.com/content/vladimirsuvorov/otus-cpp/if_filter/$TRAVIS_BUILD_NUMBER/if_filter-0.0.$TRAVIS_BUILD_NUMBER-amd64.deb;deb_distribution=trusty;deb_component=main;deb_architecture=amd64;publish=1"
